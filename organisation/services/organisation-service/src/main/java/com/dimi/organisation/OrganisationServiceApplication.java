...
import com.dimi.organisation.configuration.SpringConfiguration;
...
@EnableWebMvc
@ComponentScan(basePackages = {"com.dimi"})
@Import({SpringConfiguration.class})
public class OrganisationServiceApplication extends SpringBootServletInitializer implements WebMvcConfigurer
{
