...
import com.dimi.project.project.group.member.RemoveProjectFromGroupResult;
...
@RestController
public class RemoveProjectFromGroupAPI
{
    @Autowired private ProjectGroupMemberService projectGroupMemberService;


    @DeleteMapping(value = "/projects/{projectID}/groups/{projectGroupID}")
    public ResponseEntity<APIResponse> removeProjectFromGroup(@PathVariable(name = "projectID") UUID projectID, @PathVariable(name = "projectGroupID") UUID projectGroupID)
    {
        RemoveProjectFromGroupResult result = projectGroupMemberService.removeProjectFromGroup(projectID, projectGroupID);
